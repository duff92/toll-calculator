...
export const tollRules: TollRules = {
  ...
  holidayDates: [
    ...
    "2023-05-18", "2023-06-06", "2023-06-24", "2023-12-24",
    "2023-12-25", "2023-12-26", "2023-12-31",
    "2024-01-01", "2024-03-29", "2024-04-01", "2024-05-01",
    "2024-05-09", "2024-06-06", "2024-06-22", "2024-12-24",
 ...
 */
export function calculateDailyFee(passages: Array<{ timestamp: string; vehicleId: string }>): number {
  ...
  for (const passage of sortedPassages) {
    ...
    const diffInMinutes = (currentDate.getTime() - intervalStart.getTime()) / (1000 * 60);
